...
export function ReasoningBasic() {
  const reasoningText = `I found a potential null pointer dereference on line 42 of \`auth-handler.ts\`. The \`user\` object could be undefined when the session expires. I recommend adding a null check before accessing \`user.email\`.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              Can you review my latest PR? I refactored the auth module and
              want to make sure there are no security issues.
            </p>
          </motion.div>
